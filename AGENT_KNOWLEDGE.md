...
- **Supabase**: 
  ...
  - **Database**: PostgreSQL with RLS. Direct table queries for management pages; custom hooks for core data.
- **State & Data**:
...
- **UI System**:
  ...
  - **Dialogs**: Unified components (e.g., `NewSupplierDialog`) handle both creation and editing.
...
- **Month/Week Views**: Uses `date-fns` for interval calculation.
